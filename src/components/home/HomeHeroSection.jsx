    ...
    <div className=" min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      ...
      <div className="relative py-16 px-4">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="w-[90%] m-auto  grid lg:grid-cols-2 gap-8 items-start">
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="bg-white rounded-xl p-4 shadow-lg text-center transform hover:scale-105 transition">
              ...
              {/* Phone CTA */}
              <div className="bg-gradient-to-r from-red-600 to-red-700 rounded-2xl p-6 shadow-2xl flex items-center gap-4 transform hover:scale-105 transition">
             ...
             {/* Quote Form */}
            <div className="bg-gradient-to-br from-amber-400 via-amber-500 to-orange-500 rounded-2xl shadow-2xl p-8 transform hover:scale-105 transition-transform duration-300">
